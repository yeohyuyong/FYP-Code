...
# PCA advantage (positive = PCA better)
...
# --- Experiment 4: lockdown x c* grid ---
...
# Heatmap: red = DIIM wins, green = PCA wins
...
p5c <- ggplot(coef_df, aes(x = reorder(variable, abs(coefficient)), y = coefficient, fill = significant)) +
  ...
  coord_flip() +
  labs(title = "Experiment 5: Logistic Regression Coefficients",
