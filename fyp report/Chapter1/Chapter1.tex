...
\begin{enumerate}
    ...
    \item Evaluate five simplified structural methods for key sector identification---Total Output, PCA $\times$ xi, PageRank $\times$ xi, BL $\times$ xi, and FL $\times$ xi---against the DIIM benchmark.
