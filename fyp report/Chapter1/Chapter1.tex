...
\begin{enumerate}
    ...
    \item Evaluate five cheap structural methods for key sector identification---Total Output, PCA $\times$ xi, PageRank $\times$ xi, BL $\times$ xi, and FL $\times$ xi---against the DIIM benchmark.
    ...
    \item Determine how the performance gap between cheap methods and DIIM varies with the number of sectors targeted for intervention ($k$), identifying the regimes where cheap methods are sufficient and where DIIM remains essential.
\end{enumerate}
