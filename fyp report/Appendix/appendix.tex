...
PCA $\times$ xi top-5 sectors & 2, 5, 4, 8, 3 & 57, 54, 69, 17, 26 \\
...
\begin{itemize}
    \item \texttt{functions.R}: Core DIIM function, data loading, and simplified method implementations (Total Output, PCA $\times$ xi, PageRank $\times$ xi, BL $\times$ xi, FL $\times$ xi)
