...
\begin{itemize}
    \item \texttt{functions.R}: Core DIIM function, data loading, and cheap method implementations (Total Output, PCA $\times$ xi, PageRank $\times$ xi, BL $\times$ xi, FL $\times$ xi)
