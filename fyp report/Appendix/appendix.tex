...
\begin{itemize}
    ...
    \item \texttt{simulations/enhanced\_comparison.R}: Multi-PC PCA, varying top-$k$ sweep, and benchmark vs structured method comparison
