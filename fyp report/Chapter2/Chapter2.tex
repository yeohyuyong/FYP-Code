...
where the left factor is the proportion of unavailable workers in each sector and the right factor captures how dependent each sector is on labour as an input (Local Area Personal Income).
