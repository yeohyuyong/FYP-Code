...
This is the simplest baseline method. Sectors are ranked simply by their total planned economic output $x_i$. This method ignores the network structure entirely and assumes that intervening in the largest economic sectors will yield the greatest reduction in loss.
