...
Although both scenarios operate at the same 15-sector level, the manpower scenario is structurally distinct because the absence of a demand shock ($c^* = 0$) means the entire disruption propagation is driven by the production network alone. Furthermore, the 2022~IO table captures post-pandemic structural shifts in the economy. These structural differences have important implications for the effectiveness of cheap key sector identification methods, as explored in the following chapters.
